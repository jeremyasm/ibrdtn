...
namespace dtn
{
	namespace routing
	{
		class NewFloodRoutingExtension : public RoutingExtension, public ibrcommon::JoinableThread
		{
			static const std::string TAG;

		public:
			NewFloodRoutingExtension();
			virtual ~NewFloodRoutingExtension();
		...
		private:
			 ...
			 */
			ibrcommon::Queue<NewFloodRoutingExtension::Task* > _taskqueue;
		};
	}
}
